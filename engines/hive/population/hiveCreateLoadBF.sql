DROP TABLE IF EXISTS data_event_temporary;
CREATE EXTERNAL TABLE IF NOT EXISTS data_event_temporary
  ( 
    user_num                    STRING
  )
...
AS
SELECT * FROM data_event_temporary
;
