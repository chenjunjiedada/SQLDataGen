...
public class ColumnGenbysql {
    ...
    private int repeatValueListsize = 1;
    private Random rd;

    public ColumnGenbysql() throws Exception {
        repeatMap = new HashMap<String, Integer>();
        repeatList = new ArrayList<String>();
        rd = new Random();
    }

    public ColumnGenbysql(ColumnDefinition colDescriptor) {
